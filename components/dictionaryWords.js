    ...
    const wordSchema = {
      ...
      .then(realm => {
        realm.write(() => {
          ...
          const abaddon = realm.create('Word', {
            name: "abaddon",
            displayname: "abaddon",
            plural: "-s",
            tense: "",
            noun: "a place of destruction : an underworld abode of lost souls : HELL",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
          ...
          const abadite = realm.create('Word', {
            name: "abadite",
            displayname: "abadite",
            plural: "",
            tense: "",
            noun: "variant spelling of ibadite:1",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
          ...
          const abaft = realm.create('Word', {
            ...
            abbreviation: "",
            verb: "",
            synonyms: "Synonyms: Adverb \n aft, astern, sternward (or sternwards) \n\n Synonyms: Preposition \n back of, behind",
            antonyms: "Antonyms: Adverb \n fore, forward \n\n Antonyms: Preposition \n before",
            adjective: "",
            ...
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abaft\n Adverb: 14th century \nPreposition: 15th century \n\n History and Etymology for abaft \n Adverb: Middle English, from a- + baft in the rear, from Old English bæftan, from be- + æftan behind — more at AFT",
          });

          const abay = realm.create('Word', {
            name: "abay",
            displayname: "abay",
            plural: "",
            tense: "",
            noun: "\\ ä-ˈbī  \\ \n\n variants: or Abbai \n\n the upper course of the Blue Nile River",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
          ...
          const abaisse = realm.create('Word', {
            name: "abaisse",
            displayname: "abaisse",
            plural: "-s",
            tense: "",
            ...
            antonyms: "",
            adjective: "",
            adverb: "abais·​sé | \\ ə-ˈbā-(ˌ)sā \\ \n\n heraldry\n: ABASED",
            interjection: "",
            preposition: "",
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abaissé \n Adjective: 1823 \n Noun: circa 1899 \n\n History and Etymology for abaissé \n Adjective: borrowed from French, from past participle of abaisser “to lower” \n Noun: borrowed from French, derivative of abaisser “to lower”",
          });

          const abalienate = realm.create('Word', {
            name: "abalienate",
            displayname: "abalienate",
            plural: "",
            tense: "",
            noun: "",
            article: "",
            ...
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abalienate\n1646 \n\n History and Etymology for abalienate\n borrowed from Latin abaliēnātus, past participle of abaliēnāre “to legally transfer (property) to another,” from ab- AB- entry 1 + aliēnāre “to alienate”",
          });

          const abalienation = realm.create('Word', {
            name: "abalienation",
            displayname: "abalienation",
            plural: "",
            tense: "",
            noun: "ab·​alien·​ation | \\ (¦)a-ˌbā-lyə-ˈnā-shən, -lē-ə- \\ \n\n the act of transferring a legal title",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
            ...
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abalienation\n 1856 \n\n History and Etymology for abalienation\n borrowed from Latin abaliēnātiōn-, abaliēnātiō, derivative of abaliēnāre",
          });

          const abalone = realm.create('Word', {
            name: "abalone",
            displayname: "abalone",
            plural: "-s",
            tense: "",
            noun: "ab·​a·​lo·​ne | \\ ˌa-bə-ˈlō-nē  , ˈa-bə-ˌlō-nē  \\ \n\n any of a genus (Haliotis) of edible rock-clinging gastropod mollusks that have a flattened shell slightly spiral in form, lined with mother-of-pearl, and with a row of apertures along its outer edge \n\n Examples: \n 1. Belcher’s favorite example is the abalone shell, which is highly structured at the nanoscale, lightweight, and sturdy. \n\n2. Featured fish range from tuna, salmon and shrimp to harder-to-find selections including bluefin tuna and whole live baby abalone.",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
          ...
          const abampere = realm.create('Word', {
            name: "abampere",
            displayname: "abampere",
            plural: "-s",
            tense: "",
            noun: "ab·​am·​pere | \\ (ˈ)aˈbamˌpi(ə)r, -aam- \\ \n\n the cgs electromagnetic unit of electric current equaling 10 amperes that flows in a circular path of one centimeter radius and produces a magnetic field of 2 π oersteds at the center of the circle",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
            ...
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abampere\n 1908 \n\n History and Etymology for abampere\n AB- entry 2 + AMPERE",
          });

          const abamperes = realm.create('Word', {
            name: "abamperes",
            displayname: "abampere",
            plural: "-s",
            tense: "",
          ...
          const Aband = realm.create('Word', {
            name: "aband",
            displayname: "aband",
            plural: "",
            tense: "",
            noun: "one of the cross striations in striated muscle that contain myosin filaments and appear dark under the light microscope and light in polarized light",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
          ...
          const abandonee = realm.create('Word', {
            name: "abandonee",
            displayname: "abandonee",
            plural: "",
            tense: "",
            noun: "aban·​don·​ee \n\n plural -s \n\n one that holds or claims abandoned property \n specifically : the person (as the insurer in marine insurance) to whom property or rights are relinquished",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
            ...
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abandonee \n 1804",
          });

          const abandoner = realm.create('Word', {
            name: "abandoner",
            displayname: "abandon",
            plural: "",
            tense: "",
          ...
          const abandoners = realm.create('Word', {
            name: "abandoners",
            displayname: "abandon",
            plural: "",
            tense: "",
          ...
          const abandoning = realm.create('Word', {
            name: "abandoning",
            displayname: "abandon",
            plural: "",
            tense: "",
          ...
          const abandonment = realm.create('Word', {
            name: "abandonment",
            displayname: "abandonment",
            plural: "",
            tense: "",
            noun: "aban·​don·​ment | \\ ə-ˈban-dən-mənt  \\ \n\n 1. the act of abandoning something or someone. \n Example: In its family and social contexts, he argues, the abandonment of children was, if not a \"good thing,\" at least the most feasible means of family limitation during the many centuries when other methods were largely ineffective or, in the case of Christians, prohibited. \n\n 2. the state of being abandoned \n Example: \n fear of abandonment \n The opulence of her life as an expat wife failed to soothe her feelings of abandonment, boredom and oppression \n abandonment issues",
            article: "",
            prefix: "",
            suffix: "",
            other: "",
            ...
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abandonment \n 1593",
          });
        
          const abandonments = realm.create('Word', {
            name: "abandonments",
            displayname: "abandonment",
            plural: "",
            tense: "",
          ...
          const abandons = realm.create('Word', {
            name: "abandons",
            displayname: "abandon",
            plural: "",
            tense: "",
          ...
          const Abanic = realm.create('Word', {
            name: "Abanic",
            displayname: "Abanic",
            plural: "",
            tense: "",
          ...
          const abarthrosis = realm.create('Word', {
            ...
            conjunction: "",
            pronoun: "",
            history: "First Known Use of abarthrosis \n 1910 \n\n History and Etymology for abarthrosis \n New Latin, from ab- AB- entry 1 + arthrosis ARTHROSIS",
          });

          const abas = realm.create('Word', {
            name: "abas",
            displayname: "aba",
            plural: "",
            tense: "",
          ...
          const abase = realm.create('Word', {
            ...
            other: "abasement \n \\ ə-​ˈbās-​mənt  \\ noun",
            abbreviation: "",
            verb: "\\ ə-ˈbās  \\ \n abased; abasing \n\n transitive verb: \n\n 1. formal : to lower in rank, office, prestige, or esteem \n Example: \n abase oneself \n … the shame that had abased him within and without … \n\n 2. archaic : to lower physically \n Example: As we enter among them the great elephant makes us a bow in the best style of elephantine courtesy, bending lowly down his mountain bulk, with trunk abased and leg thrust out behind.",
            synonyms: "bastardize \n canker \n cheapen \n corrupt \n debase \n debauch \n degrade \n demean \n demoralize \n deprave \n deteriorate \n lessen \n pervert \n poison \n profane \n prostitute \n subvert \n vitiate \n warp",
            antonyms: "elevate \n ennoble \n uplift",
            adjective: "",
            adverb: "",
          ...
          const abasement = realm.create('Word', {
            name: "abasement",
            displayname: "abase",
            plural: "",
            tense: "",
          ...
          const abasements = realm.create('Word', {
            name: "abasements",
            displayname: "abase",
            plural: "",
            tense: "",
          ...
          const abases = realm.create('Word', {
            name: "abases",
            displayname: "abase",
            plural: "",
            tense: "",
